...
# ===== 장문 인식 =====
CLOVA_LONG_INVOKE_URL = os.getenv("CLOVA_LONG_INVOKE_URL")
CLOVA_LONG_SECRET_KEY = os.getenv("CLOVA_LONG_SECRET_KEY")

# ===== 실시간 gRPC =====
CLOVA_GRPC_SECRET_KEY = os.getenv("CLOVA_GRPC_SECRET_KEY")
CLOVA_GRPC_HOST = os.getenv("CLOVA_GRPC_HOST", "clovaspeech-gw.ncloud.com")
CLOVA_GRPC_PORT = int(os.getenv("CLOVA_GRPC_PORT", "50051"))
